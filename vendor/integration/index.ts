  ...
  return {
    ...
    hooks: {
      'astro:config:setup': async ({
        ...
        const { SITE, I18N, METADATA, APP_BLOG, UI, ANALYTICS, DASHBOARD, CHAT_WIDGET } = configBuilder(rawJsonConfig);
            ...
            plugins: [
              {
                ...
                load(id) {
                  if (id === resolvedVirtualModuleId) {
                    ...
                    export const DASHBOARD = ${JSON.stringify(DASHBOARD)};
                    export const CHAT_WIDGET = ${JSON.stringify(CHAT_WIDGET)};
                    `;
                  }
                },
              },
